...
const ALPHA: u32 = 5u;   // DNA alphabet: $=0,A=1,C=2,G=3,T=4
...
var<workgroup> ws_counts: array<atomic<u32>, 5>;
var<workgroup> ws_bv_lo:  array<atomic<u32>, 5>;  // bits 0-31
var<workgroup> ws_bv_hi:  array<atomic<u32>, 5>;  // bits 32-63
